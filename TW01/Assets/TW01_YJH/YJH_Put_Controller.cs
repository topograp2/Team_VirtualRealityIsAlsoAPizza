...
public class YJH_Put_Controller : MonoBehaviour
{
    bool isInTheArea;
    ...
    void Update()
    {
        ...
        {
            YJH_UI_Controller UI_Script = UI_Controller.GetComponent<YJH_UI_Controller>();
    ...
    void ThrowHeart()
    {
        UI_Controller.GetComponent<YJH_UI_Controller>().Decrease_PickCounter();
